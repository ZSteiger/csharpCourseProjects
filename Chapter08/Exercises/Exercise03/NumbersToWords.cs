...
public static class NumbersToWords
{
    ...
    {
        // TODO: Finish so that big integers are considered. Currently it maxes at the upperLimit of Int32, and anything larger than 1 billion prints as 1 thousand million.
        if (number == 0)
            return "zero";
